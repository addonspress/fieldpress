...
function fieldpress_render_icon( $field_details, $field_value ) {
	...
	$output = "<div class='fieldpress-icon-preview". esc_attr( $hidden ) ."'><div class='fieldpress-icon-wrap'><i class='dashicons dashicons-no fieldpress-icon-clear'></i><a href='#' class='fieldpress-icon-selector-open'><i class='fa ". esc_attr( $field_value ) ."' /></i></a></div></div>";
