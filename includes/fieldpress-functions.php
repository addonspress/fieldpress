...
function fieldpress_enqueue_scripts( $all_fields, $unique = false ) {
	...
	if( apply_filters('fieldpress_fa_version',5 ) == '4.7.0'){
	    $fa_src = FIELDPRESS_URL . 'assets/frameworks/font-awesome-4.7.0/css/font-awesome'.FIELDPRESS_SCRIPT_PREFIX.'.css';
    }
    else{
...
function fieldpress_get_icons(){
	...
	$fieldpress_get_icons = apply_filters( 'fieldpress_get_icons', $font_awesome_icons );
